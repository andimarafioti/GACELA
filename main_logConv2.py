...
from ganSystemLogConv import GANSystemLogConv
...
# params_discriminator['nfilter'] = [int(nfilter/2) for nfilter in params_discriminator['nfilter']]
...
args['generator_input'] = 2 * 6 * 4 * 2 * (md//4) + 24 * 4
...
args['experiment_name'] = 'pytorch_nc1_logconv_2'
...
ganSystem = GANSystemLogConv(args)

...
from ganSystemGenLogConv import GANSystemGenLogConv
...
params_generator['stride'] = [1, 1, 2, 2, 2]
params_generator['latent_dim'] = 100
params_generator['nfilter'] = [8*md, 4*md, 2*md, md, 1]
params_generator['shape'] = [[3, 3], [3, 3], [8, 8], [8, 8], [8, 8]]
params_generator['padding'] = [1, 1, 3, 3, 3]
params_generator['full'] = 256*md
params_generator['summary'] = True
params_generator['data_size'] = 2
params_generator['spectral_norm'] = True
params_generator['in_conv_shape'] = [8*4, 4*4]
...
args['experiment_name'] = 'pytorch_nc1_genLogConv'
...
ganSystem = GANSystemGenLogConv(args)

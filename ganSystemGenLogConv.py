...
from model.generatorLogConv import GeneratorLogConv
...
class GANSystemGenLogConv(object):
	def __init__(self, args):
		super(GANSystemGenLogConv, self).__init__()
		self.args = args
		...
		self.generator = GeneratorLogConv(args['generator'], args['generator_input']).to(device)
